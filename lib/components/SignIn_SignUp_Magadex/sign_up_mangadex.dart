// ignore_for_file: library_private_types_in_public_api, non_constant_identifier_names, use_build_context_synchronously, avoid_print
...
class _RegisterFormDialogState extends State<RegisterFormDialog> {
  ...
  Future<void> IsEmptyAccount(String username, String password, String clientId,
    ...
    String? response =
        await getResfreshingToken(username, password, clientId, secretId);
    if (response != null) {
  ...
  Widget Decrepsion() {
    ...
    return RichText(
      text: TextSpan(
        text:
            "You can get your Client ID and Secret ID by registering an account on Mangadex website. For more information, please visit",
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      ...
                      await IsEmptyAccount(
                          username, password, clientId, secretId);
                    },
...
void FetchDataToFireStore({required ApiVariables apiVariables}) {
  CollectionReference account =
      FirebaseFirestore.instance.collection('mangadex_account');
  account
